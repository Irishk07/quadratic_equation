...
void run_one_test(double a, double b, double c, int cnt_roots_test, double root1, double root2) {
...
void run_all_test() { 
    //          +-------+---------+-----+--------+-------+--------+
    //          |   a   |    b    |  c  | nRoots |   x1  |   x2   |
    run_one_test(      1,       -5,    6,     TWO,      2,       3); //2 3
    run_one_test(      2,       -9,    4,     TWO,    0.5,       4); //0.5 4
    run_one_test(      1,        4,    4,     ONE,     -2,       0); //-2
    run_one_test(   1000,    -2000, 1000,     ONE,      1,       0); //1
    run_one_test(      7,        8,  150,    ZERO,      0,       0); //no
    run_one_test(    -18,      -68, -550,    ZERO,      0,       0); //no
    run_one_test(      0,        5,   -8,     ONE,    1.6,       0); //1.6
    run_one_test(1000000,        0,   -1,     TWO, -0.001,   0.001); //-0.001 0.001
    run_one_test(      1, -1000000,    0,     TWO,      0, 1000000); //0 1000000
    run_one_test(      0,        0,  -15,    ZERO,      0,       0); //no
    run_one_test(      0,       -8,    0,     ONE,      0,       0); //0
    run_one_test(      9,        0,    0,     ONE,      0,       0); //0
    run_one_test(      0,        0,    0,     INF,      0,       0); //inf
    //          +-------+---------+-----+--------+-------+--------+
