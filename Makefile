...
CPPFLAGS = -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code -Wmissing-declarations -Wmissing-include-dirs \
...
CPPSRC = main.cpp solver.cpp in_out_put.cpp cat.cpp test.cpp pass_arg.cpp
